...
# plot 2		
		plot(as.POSIXlt(daytime),pcons$Voltage,type="l",xlab="datetime",ylab="Voltage")
# plot 3		
		...
		legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"),
			   col = c("black", "red", "blue"),text.col = "black", lty = c(1, 1, 1),lwd=c(2,2,2),merge = TRUE)
# plot 4
		plot(as.POSIXlt(daytime),pcons$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power")
		dev.off()
	}
# here wo go ---------------------------------------------------------------------------------------------------------
	pcons=readFile(url)
